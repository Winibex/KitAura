// lib/features/cover_letter/view/cl_template_card_widget.dart
...
class ClTemplateCardWidget extends StatelessWidget {
  final ClTemplateInfo template;
  final VoidCallback onTap;

  const ClTemplateCardWidget({
    super.key,
