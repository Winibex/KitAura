// lib/features/proposal/template/view/prop_template_preview_modal.dart
...
class PropTemplatePreviewModal extends StatefulWidget {
  final PropTemplateInfo info;
  final VoidCallback onUse;

  const PropTemplatePreviewModal({
    super.key,
    required this.info,
    required this.onUse,
  });
  ...
  @override
  State<PropTemplatePreviewModal> createState() =>
      _PropTemplatePreviewModalState();
}

class _PropTemplatePreviewModalState extends State<PropTemplatePreviewModal> {
  bool _loading = true;
  ...
  Future<void> _loadPages() async {
    try {
      ...
      debugPrint('Proposal preview load failed: $e');
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(children: [
                        _badge(
                            widget.info.category[0].toUpperCase() +
                        ...
                        if (widget.info.isPremium) ...[
                          ...
                          _badge(
                              'Pro', AppColors.dustyMauve, AppColors.white),
                        ],
                      ]),
                      ...
                      const SizedBox(height: 16),
                      _featureItem(
                          LucideIcons.sparkles, 'AI content generation ready'),
                      _featureItem(
                          LucideIcons.move, 'Fully customizable layout'),
                      _featureItem(
                          LucideIcons.download, 'PDF export included'),
                      _featureItem(
                          LucideIcons.layers, 'Multi-page support'),
                    ],
                  ),
                ),
              ],
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _featureItem(
                    LucideIcons.download, 'PDF export included'),
                _featureItem(LucideIcons.layers, 'Multi-page support'),
